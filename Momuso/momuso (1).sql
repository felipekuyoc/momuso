...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2024 a las 04:55:54
...
INSERT INTO `carritodecompras` (`ID_Carrito`, `ID_Usuario`, `ID_Producto`, `Cantidad`) VALUES
(16, 1, 1, 2),
(17, 2, 2, 1),
(18, 3, 3, 3),
(19, 4, 4, 1),
...
(1, 'Camisa de Moda', 'Camisa casual de hombre', 25.99, 97, 'camisa.jpg', 1),
(2, 'Reloj Deportivo', 'Reloj resistente al agua', 50.00, 48, 'reloj.jpg', 2),
(3, 'Muñeca de Juguete', 'Muñeca articulada para niñas', 20.00, 200, 'muneca.jpg', 3),
(4, 'Crema Facial', 'Crema hidratante para la piel', 15.75, 150, 'crema.jpg', 4),
...
(46, 1, 1, 4, 'El producto es de excelente calidad, superó mis expectativas.', '2024-11-20 16:17:44'),
...
(7, 'Katherine ', 'kathe@gmail.com', '$2y$10$LQOiuf89e52/JSzBBfURieW84healsvuo4Zmg3uWlhK08b5UiHClC', 'Cliente'),
...
--
ALTER TABLE `reseñasycomentarios`
  MODIFY `ID_Reseña` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
